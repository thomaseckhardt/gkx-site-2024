  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        13: [rem(13), { lineHeight: '1.1' }],
        15: [rem(15), { lineHeight: '1.1' }],
        16: [rem(16), { lineHeight: '1.1' }],
        18: [rem(18), { lineHeight: '1.1' }],
        20: [rem(20), { lineHeight: '1.1' }],
        22: [rem(22), { lineHeight: '1.1' }],
        25: [rem(25), { lineHeight: '1.1' }],
        32: [rem(32), { lineHeight: '1.1' }],
        35: [rem(35), { lineHeight: '1.1' }],
        38: [rem(38), { lineHeight: '1.1' }],
        40: [rem(40), { lineHeight: '1.1' }],
        42: [rem(42), { lineHeight: '1.1' }],
        45: [rem(45), { lineHeight: '1.1' }],
        50: [rem(50), { lineHeight: '1.1' }],
      },
      fontWeight: {
